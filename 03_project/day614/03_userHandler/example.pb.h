...
inline const std::string& LoginResponse::code() const {
  // @@protoc_insertion_point(field_get:LoginResponse.code)
  return _internal_code();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void LoginResponse::set_code(ArgT0&& arg0, ArgT... args) {
 
 code_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:LoginResponse.code)
}
inline std::string* LoginResponse::mutable_code() {
  std::string* _s = _internal_mutable_code();
  // @@protoc_insertion_point(field_mutable:LoginResponse.code)
  return _s;
}
inline const std::string& LoginResponse::_internal_code() const {
  return code_.Get();
}
inline void LoginResponse::_internal_set_code(const std::string& value) {
  
  code_.Set(value, GetArenaForAllocation());
}
inline std::string* LoginResponse::_internal_mutable_code() {
  
  return code_.Mutable(GetArenaForAllocation());
}
inline std::string* LoginResponse::release_code() {
  // @@protoc_insertion_point(field_release:LoginResponse.code)
  return code_.Release();
}
inline void LoginResponse::set_allocated_code(std::string* code) {
  if (code != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:LoginResponse.code)
}
