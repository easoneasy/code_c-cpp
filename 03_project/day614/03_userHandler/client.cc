...
static void login_done(LoginResponse *response, srpc::RPCContext *context)
{
}
...
int main()
{
    ...
    // 2. 创建SRPCClient任务
    SRPCClientTask* task = client.create_Register_task(register_callback);
    // 设置请求
    RegisterRequest req;
    req.set_username("eason");
