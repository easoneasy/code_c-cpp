...
static ::_pb::Metadata file_level_metadata_example_2eproto[6];
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 17, -1, -1, sizeof(::LoginRequest)},
  { 25, -1, -1, sizeof(::LoginResponse)},
  { 35, -1, -1, sizeof(::UserInfoRequest)},
  { 42, -1, -1, sizeof(::UserInfoResponse)},
};
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "LoginResponse.code"));
        } else
          goto handle_unusual;
        continue;
      // string token = 4;
